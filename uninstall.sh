...
uninstall_arch_packages() {
  ...
  local official_pkgs=(zsh tmux stow aws-cli-v2 azure-cli cmatrix difftastic elixir erlang ffmpeg git-filter-repo make ollama openssh telegram-desktop tree yazi)
